 ...
 * @author bandenk
 */
public class FilterDVD implements ActionInterface{
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            ...
            dvds = Koneksi.getdVDDao().readByCategory(id);
        } catch (Exception ex) {
            Logger.getLogger(FilterDVD.class.getName()).log(Level.SEVERE, null, ex);
        }
